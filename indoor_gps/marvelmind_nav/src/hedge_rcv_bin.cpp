...
#define HEDGE_POSITION_TOPIC_NAME "/bair_car/hedge_pos"
#define HEDGE_POSITION_ADDRESSED_TOPIC_NAME "/bair_car/hedge_pos_a"
#define BEACONS_POSITION_ADDRESSED_TOPIC_NAME "/bair_car/beacons_pos_a"
