print('pytorch2/Train')
from kzpy3.utils2 import *
pythonpaths(['kzpy3','kzpy3/pytorch2/nets','kzpy3/pytorch2/Train_SqueezeNet'])
from vis2 import *
import torch
import Data_preload
from Data_train_load import get_data_considering_high_low_steer as get_data_function
...
while True:
    ...
    batch = Batch.Batch({'net':net})
    
    batch['fill']({'get_data_function':get_data_function,'get_data_args':{'all_steer':Data_preload.all_steer}})
