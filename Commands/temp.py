...
Q = {
    '==file==': __file__,
    '==project_path==',
    '==parent_leys==':('commands','Train_app'),
    'commands':{
        'Cars':{
                'a2Apr19_16April2019':{
                    '--mode--':'bash',
                    ...
                    '==keys==':('commands','Cars','a2Apr19_16April2019')
                },
            },
        },
        'Train_app':{
            '==keys==':('commands','Train_app')
        ...
        'tests': {
            ...
            'b': 99,
            'more': {
                '==keys==':('commands','tests','more')
                'c': True,
                'more': {
                    '==keys==':('commands','tests','more','more')
                    '--mode--':'const',
                    'd':'abc',
                    'e':[1],
                },
