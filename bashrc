...
OPTIONS="exit screen rla rlanr rosbags git_pull reboot shutdown rostopics df car_link_menu screen_menu"
COLUMNS=12
echo 'main menu'
select opt in $OPTIONS; do
   ...
   elif [ "$opt" = "screen_menu" ]; then
    ~/kzpy3/Cars/screen_menu.sh
