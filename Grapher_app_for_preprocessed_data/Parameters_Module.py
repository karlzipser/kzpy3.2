...
P[TOPICS] = {
	...
	'cmd_steer':{maxval:80,		minval:20,		baseline:49.0,	color:(255,255,0)},
	'cmd_motor':{maxval:80,		minval:49,		baseline:49.0,	color:(0,255,255)},
	'drive_mode':{maxval:80,		minval:20,		baseline:49.0,	color:(255,0,0)},
	'human_agent':{maxval:80,		minval:20,		baseline:49.0,	color:(0S,255,0)},
