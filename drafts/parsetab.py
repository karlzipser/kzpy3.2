...
_lr_productions = [
  ...
  ('statement -> NAME EQUALS expression','statement',3,'p_statement_assign','eg2.py',60),
  ('statement -> expression','statement',1,'p_statement_expr','eg2.py',64),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','eg2.py',68),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','eg2.py',69),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','eg2.py',70),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','eg2.py',71),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','eg2.py',78),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','eg2.py',82),
  ('expression -> NUMBER','expression',1,'p_expression_number','eg2.py',86),
  ('expression -> NAME','expression',1,'p_expression_name','eg2.py',90),
]
