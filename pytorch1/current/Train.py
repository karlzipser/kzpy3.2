...
pythonpaths(['kzpy3','kzpy3/pytorch1','kzpy3/pytorch1/current','kzpy3/pytorch1/nets'])
from vis2 import *
import torch
import Data
...
while True:
    ...
    batch = Batch.Batch({'net':net,'batch_size':BATCH_SIZE})
    
    batch['fill']({
        'get_data_function':get_data_function,
        'get_data_args':{'N_STEPS':net.N_STEPS,'N_FRAMES':net.N_FRAMES,'ignore':ignore,'require_one':require_one,'use_states':use_states}})
