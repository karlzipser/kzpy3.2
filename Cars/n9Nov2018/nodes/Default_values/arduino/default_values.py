...
P['weight_file_path'] = '/home/karlzipser/Desktop/net_15Sept2018/weights'# opjh('pytorch_models/epoch6goodnet')#opjD('link_to_weights_file.SqueezeNet')#opjh('pytorch_models','net_10Jun18_00h00m45s.SqueezeNet')
P['USE_NETWORK'] = True
