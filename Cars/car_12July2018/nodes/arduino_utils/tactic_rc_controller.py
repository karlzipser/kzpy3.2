    ...
    while P['ABORT'] == False:
        ...
        try:
            ...
            if 'Do smoothing...'
                ...
                P['servo_pwm_smooth'] = (1.0-s)*RC['servo_pwm'] + s*P['servo_pwm_smooth']
                P['motor_pwm_smooth'] = (1.0-s)*RC['motor_pwm'] + s*P['motor_pwm_smooth']

            if 'Send servo/motor commands to Arduino...':
                write_str = d2n( '(', int(D['servo_pwm']), ',', int(D['motor_pwm']+10000), ')')
