...
def Quartet(name='no_name'):
    ...
    a = z55(np.random.random((10,10,3)))
    a = cv2.resize(a,(50,54))
    #print shape(a)

    def _function_mess_with_image(size_='full'):
        if is_even(int(time.time()/2)):
            for size_ in ['full']:
                D['left']['now'][size_][20:-20,20:70,:] = 255-D['right']['prev'][size_][20:-20,-50:,:]
                D['right']['now'][size_][20+4:-20+4,30:80,:] = 255-D['left']['prev'][size_][20:-20,-50:,:]
                D['left']['prev'][size_][20:-20,20:70,:] = 255-D['right']['now'][size_][20:-20,-50:,:]
                D['right']['prev'][size_][20:-20,30:80,:] = 255-D['left']['now'][size_][20:-20,-50:,:]
    ...
    D['mess_with_image'] = _function_mess_with_image
    return D
