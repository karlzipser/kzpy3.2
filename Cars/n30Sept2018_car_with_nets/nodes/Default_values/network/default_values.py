...
N = {}
N['menu name'] = 'network menu'
N['ABORT'] = False
N['to_hide'] = []
N['The menu path.'] = opjk('Cars/car_24July2018/nodes/Default_values/network')
if True:
	N['ABORT'] = False
...
if False:
	...
	N['network_steer_gain'] = 2.0
	N['network_camera_gain'] = 2.0
	N['network_motor_gain'] = 0.333
	N['network_motor_offset'] = 0
	N['network_servo_smoothing_parameter'] = 0.95
	N['network_motor_smoothing_parameter'] = 0.75
	N['network_camera_smoothing_parameter'] = 0.75
	N['weight_file_path'] = opjh('pytorch_models','net_10Jun18_00h00m45s.SqueezeNet')
	N['USE_NETWORK'] = True
	N['GREY_OUT_TOP_OF_IMAGE'] = False
