...
def ros_init(N):
    ...
    #N['pub']['net/camera'] = rospy.Publisher(
    #    'net/camera',std_msgs.msg.Int32,queue_size=5)

    N['pub']['net/steer'] = rospy.Publisher(
        'net/steer',std_msgs.msg.Int32,queue_size=5)

    N['pub']['net/motor'] = rospy.Publisher(
        'net/motor',std_msgs.msg.Int32,queue_size=5)
