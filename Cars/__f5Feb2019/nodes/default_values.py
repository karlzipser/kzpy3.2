...
try:
    _['flex_weight_file_path'] = most_recent_file_in_folder(opjm('rosbags/Network_Weights/net_flex'))
    assert type(_['flex_weight_file_path']) == str
except:
    print 'except'
    _['flex_weight_file_path'] = most_recent_file_in_folder(opjD('Network_Weights/net_flex'))
...
_['desktop version/start index'] = 3000
