...
hw = half_wall_length
tmp = Graph_Image(xmin,-6.03+hw, xmax,hw, ymin,-(6.03)/2.0, ymax,(6.03)/2.0, xsize,rp.img_width, ysize,rp.img_width)
...
Potential_graph = Graph_Image(xmin,-6.03+hw, xmax,hw, ymin,-(6.03)/2.0, ymax,(6.03)/2.0, xsize,rp.img_width, ysize,rp.img_width, Img,tmp)
#
