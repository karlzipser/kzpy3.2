...
Q = {
	'net': {
		'show': {
			...
			'network_camera_gain_direct': 0.5,     
			'network_motor_gain_direct': 0.0,
...
_['To Expose']['Network'] = []
for sh in ['show','hide']:
	for n in Q['net'][sh].keys():
		_[n] = Q['net'][sh][n]
		if sh == 'show':
			_['To Expose']['Network'].append(n)
