...
Q['NETWORK']['to_expose'] = {
	'ldr_gain':0.333,
	'network_output_sample':0, # >= 0, <= 9
	'network_steer_gain':2.0,
	'network_camera_gain':4.0,
	'network_motor_gain':0.8,
	'low velocity direct steer gain':4.0,
	'network_reverse_motor_gain':1.,
	'network_motor_offset':0,
	'network_servo_smoothing_parameter':0.85,
	'network_motor_smoothing_parameter':0.85,
	'network_camera_smoothing_parameter':0.75,
	'network_servo_smoothing_parameter_direct':0.85,
	'network_steer_gain_direct':1.5,
	'network_camera_gain_direct':0.0,     
	'network_motor_gain_direct':1.0,
	'USE_NETWORK':True,
	'visualize_activations':False,
	'camera_auto_zero_for_small_values_int']:0,
	'cmd_camera_to_camera_heading_cooeficient':0.0,
	'temp_camera':49,
}
Q['NETWORK]'['to_hide'] = {
	'GREY_OUT_TOP_OF_IMAGE':False,
	'USE_LAST_IMAGE_ONLY':False,
	'camera_move_threshold':0,
}
...
for l in ['NETWORK']:
	_['To Expose'][l] = []
	for k in sorted(Q[l]['to_expose']):
		P['To Expose'][l].append(k)
	for k in Q[l].keys():
		P[k] = Q[l][k]
