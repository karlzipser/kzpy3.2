...
N = default_values.P
import rospy
#import kzpy3.Cars.n27Oct2018_car_with_flex.nodes.flex_net_utils as flex_net_utils
...
while not rospy.is_shutdown():
    ...
    try:
        ...
        cg("flex_torch_motor, flex_torch_steer =",flex_torch_motor, flex_torch_steer)
