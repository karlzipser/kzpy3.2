...
Q = {
    '--mode--':'bash',
    'arduino_node':'python '+project_path+'/nodes/arduino_node.py',
    'network_node':'python '+project_path+'/nodes/network_node.py',
    'control_node':''+project_path+'/nodes/control_node.py',
    'menu2':'python kzpy3/Menu_app/menu2.py path '+project_path+'/nodes dic P', 
