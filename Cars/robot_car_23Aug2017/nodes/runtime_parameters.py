...
Car_IP_dic = {'Mr_Blue':'192.168.1.101',
	...
	'Mr_Orange_Blue':'192.168.1.103',
	'Mr_Yellow_Blue':'192.168.1.104',
...
robot_steer = 49
robot_motor = 60
robot_steer_gain = 0.5
potential_field_png = opjD('markers.crop.35x35.new2.png')
past_to_present_proportion = 0.0
steer_momentum = 0.0
heading_pause_threshold_angle = 7
heading_float_pause_threshold = 10.98
X_PARAM = 1.0
Y_PARAM = 1.0
