...
OPTIONS="exit ls bdd_car_rewrite_SD2 bdd_car_rewrite_SD2_LCR bdd_car_rewrite_SD2_LCR_net 
  ...
  aruco_driver_16Sept2017 aruco_driver_17Sept2017_MSE_only car_12July2018 car_16July2018"
COLUMNS=12
echo 'car_link_menu:'
select opt in $OPTIONS; do
   ...
   elif [ "$opt" = "car_12July2018" ]; then
    rm ~/catkin_ws/src/bair_car
    ln -s ~/kzpy3/Cars/car_12July2018 ~/catkin_ws/src/bair_car
    ls -al ~/catkin_ws/src/bair_car


   elif [ "$opt" = "car_16July2018" ]; then
    rm ~/catkin_ws/src/bair_car
    ln -s ~/kzpy3/Cars/car_16July2018 ~/catkin_ws/src/bair_car
    ls -al ~/catkin_ws/src/bair_car
