...
#from disk or callback, headign, encoders, motors and behavioral_mode have values
    ...
    while _['index'] < len(U['ts']):
        ...
        try:
            ...
            for behavioral_mode in _['behavioral_mode_list']:
                ...
                pts2D_1step = get_latest_network_2D_trajectory_predictions(headings,encoders,_['motors'])
