...
class ConDecon(nn.Module):
    ...
    def __init__(self):
        ...
        self.fire1=Fire(3,1,1,1)
        self.fire2=Fire(2,1,1,1)
        self.fire3=Fire(2,1,1,1)
        self.fire4=Fire(2,1,1,1)
        ...
        #self.maxpool4= nn.MaxPool2d(kernel_size=3,stride=2,return_indices=True,padding=0)
        self.maxpool= nn.MaxPool2d(kernel_size=3,stride=2,return_indices=True,padding=0)

        self.smoke4=Smoke(2,1,1,1)
        self.smoke3=Smoke(2,1,1,1)
        self.smoke2=Smoke(2,1,1,1)
        self.smoke1=Smoke(2,1,1,3)
        ...
        #self.maxunpool_size_fire3=nn.MaxUnpool2d(kernel_size=3,stride=2,padding=0)
