...
class GoogLeNet(nn.Module):
    ...
    def __init__(self, num_classes=1024, aux_logits=True, transform_input=False, init_weights=True,
                 blocks=None):
    ...
    def forward(self, x):
        ...
        if False:
            ...
            return x#self.eager_outputs(x, aux2, aux1)
...
if False:
    ...
    x = g.forward(torch.rand((1,3,300,300)))
