...
import kzpy3.scratch.VT_b.default_values as default_values
import kzpy3.scratch.VT_b.fit3d as fit3d
P = default_values.P
Point3 = fit3d.Point3
project = fit3d.project

if P['start menu automatically']:
    os.system(d2n("gnome-terminal -x python kzpy3/Menu_app/menu2.py path ","kzpy3/scratch/VT_b"," dic P"))
...
def load_parameters(P):
    if parameter_file_load_timer.check():
        Topics = menu2.load_Topics(opjk("scratch/VT_b"),first_load=False,customer='customer0')
        if type(Topics) == dict:
