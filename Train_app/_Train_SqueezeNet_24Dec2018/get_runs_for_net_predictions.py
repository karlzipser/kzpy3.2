...
if True:
	...
	for l in locations_to_classify:
		...
		cb("...done.")
	if verbose: print len(_['experiments_folders'])
	if verbose: print _['experiments_folders']
	#raw_enter()
################################################################
if True:
################################################################
...
for experiments_folder in _['experiments_folders']:
	...
	for location in locations:
		...
		for e in b_modes:
			...
			"""
			cb("\t",fname(e))
			_['run_folders'] += sggo(e,'h5py/*')

so(_['run_folders'],opjD('Data/Network_Predictions/runs.pkl'))
