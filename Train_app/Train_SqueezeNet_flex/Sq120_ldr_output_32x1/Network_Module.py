...
import torch
from kzpy3.Train_app.nets.SqueezeNet120_32x1 import SqueezeNet
...
if False:
    ...
    import kzpy3.Train_app.nets.SqueezeNet120_32x1
    A = load_net(most_recent_file_in_folder(opjD('Networks/Sq120_ldr_output_4April2019/weights'),['.infer'],[]))
    B = kzpy3.Train_app.nets.SqueezeNet120_32x1.SqueezeNet().cuda()
    C = B.state_dict()
    for k in A.keys():
