...
elif Args['MARKERS'] == 'circle11half':
...
if 'BATCH' in Args:
	if Args['BATCH'] == 'True':
		for color in ['Blue','Lt_Blue','Orange','Black','Yellow','Purple']:
			os.system(d2s("xterm -hold -e python",opjh('kzpy3/Localization_app/visualize_cars_with_gaussians__3b.py'),'MARKERS',Args['MARKERS'],'DATA_FOLDER',data_folder,'CAR_NAME','Mr_'+color,'&'))
			pause(2)
		raw_enter();
		exit()
		assert(False)
