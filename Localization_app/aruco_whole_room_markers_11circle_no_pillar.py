...
markers_clockwise = p4+p5+p6+p7#+p8+p9+p10+p11+p12+p1+p2#+p3
#markers_clockwise = p1+p2+p3+p4+p5+p6+p7+p8+p9+p10+p11+p12
=======
p1=[199,200,202,203]	#
...
>>>>>>> 19c4ef671fa3dd35b8ab72011b70a1c23cd2c2d9
