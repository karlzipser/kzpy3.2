...
pythonpaths(['kzpy3','kzpy3/pytorch3/nets3','kzpy3/pytorch3/Train_SqueezeNet'])
from vis2 import *
import torch
import Data
import Batch
...
while True:
    for mode in ['train','val']:
        ...
        while not timer[mode].check():
            ...
            Utils.save_net({'net':net,'loss_record':loss_record,'weights_folder_path':P.WEIGHTS_FOLDER_PATH})
