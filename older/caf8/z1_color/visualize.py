...
#          SETUP SECTION
#
solver_file_path = opjh("kzpy3/caf8/z1_color/solver.prototxt")
#
########################################################
...
solver = setup_solver()
weights_file_path = most_recent_file_in_folder(opjD('z1_color'),['.caffemodel'])
...
for n in range(96):
	...
	for c in range(3):
		img[2:width+2,2:width+2,c] = solver.net.params['conv1'][0].data[n,0+c,:,:]
