...
#          SETUP SECTION
#
solver_file_path = opjh("kzpy3/caf8/z2_color_small_ip1/solver.prototxt")
#
########################################################
...
solver = setup_solver()
weights_file_path = most_recent_file_in_folder(opjD('z2_color_small_ip1'),['caffemodel']) #'/home/karlzipser/caffe_models/z2_color.caffemodel'#most_recent_file_in_folder(weights_file_path,['z2_color','caffemodel'])
